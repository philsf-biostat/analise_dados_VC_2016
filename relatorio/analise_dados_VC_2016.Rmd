...
Nos pacientes que apresentaram tromboembolismo venoso sintomático, `r HAS.pos` dos pacientes apresentaram hipertensão arterial, `r DR.pos` Doença Reumática, em `r Artri.pos` a Artrite Reumatoide, em `r AVE.pos` AVE, em `r DM.pos` Diabetes Mellitus e em `r Cardio.pos` Cardiopatia.
